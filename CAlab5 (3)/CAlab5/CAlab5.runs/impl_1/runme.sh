...
HD_PWD='D:/Downloads/CAlab5/CAlab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_ControlPath.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_ControlPath.tcl -notrace
