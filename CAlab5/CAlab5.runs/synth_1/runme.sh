...
HD_PWD='D:/Downloads/CAlab5/CAlab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_ControlPath.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_ControlPath.tcl
